...
from Environments.QMIX_reduced.TB_env_QMIX_reduced_V2_Navigate import TwoBridgeEnv
...
def get_agent_save_root(config: TrainConfig):
    return PROJECT_ROOT / "Agents" / "Qmix_reduced" / config.map_name / "saved_models" / config.agent_name


def get_agent_tb_root(config: TrainConfig):
    return PROJECT_ROOT / "tb_logs" / "Qmix_reduced" / config.map_name / config.agent_name
