...
# Absolute model path
MODEL_PATH = os.path.join(project_root, "Agents", "A2C", "saved_models", AGENT_NAME, f"{AGENT_NAME}_final.zip")
EPISODES = 3
RENDER = False

# Replay output directory
replay_output_dir = os.path.abspath(
    os.path.join(project_root, "Replays", "A2C", AGENT_NAME)
)
...
performance_folder = os.path.join(project_root, "Agent Performance Charts", "A2C", AGENT_NAME)
