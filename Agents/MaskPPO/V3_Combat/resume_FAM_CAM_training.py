# Agents/MaskPPO/V1_Base_Cam/SB_MPPO_FAM_CAM_resume.py
...
from Environments.FAM_CAM.TB_env_FAM_V3_Combat_Cam import TwoBridgeEnv, N_FRIEND, N_ENEMY
...
resume_k  = 2500  # e.g., 500, 1000, 1500, ..., 5000
ckpt_path = f"{save_dir}{agent_name}_{resume_k}K.zip"

# (B) Or point directly:
# ckpt_path = r"./Agents/MaskPPO/V1_Base_Cam/saved_models/SB_MaskPPO_FAM_CAM/SB_MaskPPO_FAM_CAM_3000K.zip"
