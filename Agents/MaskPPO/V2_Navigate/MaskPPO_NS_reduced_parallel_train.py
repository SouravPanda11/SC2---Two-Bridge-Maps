...
from Environments.NS_AM_RM_mean_reduced.V2_Navigate_NS import TwoBridgeEnv, N_FRIEND, N_ENEMY
...
BASE_AGENT_NAME = "MaskPPO_NS_reduced"
INCLUDE_PLAYER_RELATIVE = True
AGENT_NAME = BASE_AGENT_NAME if INCLUDE_PLAYER_RELATIVE else f"{BASE_AGENT_NAME}_pathable_only"
...
def train_for_seed(args, rollout_size, seed, resume_checkpoint=None):
    ...
    print(
        ...
        f"include_player_relative={args.include_player_relative}"
    )
    print(
        "Timing note | "
