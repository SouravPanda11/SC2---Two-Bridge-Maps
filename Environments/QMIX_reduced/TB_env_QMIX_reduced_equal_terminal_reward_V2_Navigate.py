from Environments.QMIX_reduced._qmix_reduced_equal_terminal_reward_base import (
    TwoBridgeMapConfig,
    TwoBridgeQMixEqualTerminalRewardReducedEnvBase,
)
...
class TwoBridgeQMixEqualTerminalRewardEnv(
    TwoBridgeQMixEqualTerminalRewardReducedEnvBase
):
...
class TwoBridgeQMixEqualTerminalRewardPathableOnlyEnv(
    TwoBridgeQMixEqualTerminalRewardEnv
):
    def __init__(self, map_name="V2_Navigate", **kwargs):
        super().__init__(
            map_name=map_name,
...
TwoBridgeEnv = TwoBridgeQMixEqualTerminalRewardEnv
