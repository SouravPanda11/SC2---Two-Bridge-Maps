...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V3_Navigate.
    ...
    def __init__(
        ...
        if map_name != "V3_Navigate":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V3_Navigate' is implemented.")
