...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V2_Combat.
    ...
    def __init__(
        ...
        if map_name != "V2_Combat":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V2_Combat' is implemented.")
