...
class TwoBridgeMap_V3_Base(lib.Map):
    name = "TwoBridgeMap_V3_Base"
    directory = r"C:/Program Files (x86)/StarCraft II/Maps/Strategy Maps/Camera Free"
    filename = "TwoBridgeMap_V3_Base.SC2Map"
    players = 2


lib.get_maps().pop("TwoBridgeMap_V3_Base", None)
lib.get_maps()["TwoBridgeMap_V3_Base"] = TwoBridgeMap_V3_Base()
...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V3_Base.
    ...
    def __init__(
        ...
        if map_name != "V3_Base":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V3_Base' is implemented.")
