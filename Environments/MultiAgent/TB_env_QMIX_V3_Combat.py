...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V3_Combat.
    ...
    def __init__(
        ...
        if map_name != "V3_Combat":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V3_Combat' is implemented.")
