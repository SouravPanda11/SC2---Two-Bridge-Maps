...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V2_Navigate.
    ...
    def __init__(
        ...
        if map_name != "V2_Navigate":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V2_Navigate' is implemented.")
