...
class TwoBridgeQMixEnv:
    """
    Multi-agent raw-action environment for TwoBridgeMap_V1_Combat.
    ...
    def __init__(
        ...
        if map_name != "V1_Combat":
            raise ValueError(f"Unsupported map_name={map_name!r}. Only 'V1_Combat' is implemented.")
