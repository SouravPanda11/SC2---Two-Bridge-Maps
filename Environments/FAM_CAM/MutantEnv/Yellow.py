...
# ───────────────────── Map registration ───────────────────────
class Yellow(lib.Map):
    name      = "Yellow"
    directory = r"C:/Program Files (x86)/StarCraft II/Maps/Strategy Maps/Camera Lock/Mutants"
    filename  = "Yellow.SC2Map"
    players   = 2

lib.get_maps().pop("Yellow", None)
lib.get_maps()["Yellow"] = Yellow()
