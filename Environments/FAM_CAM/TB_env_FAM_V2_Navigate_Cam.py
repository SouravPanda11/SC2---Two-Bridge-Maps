...
# ───────────────────── Map registration ───────────────────────
class TwoBridgeMap_V2_Navigate_Cam(lib.Map):
    name      = "TwoBridgeMap_V2_Navigate_Cam"
    directory = r"C:/Program Files (x86)/StarCraft II/Maps/Strategy Maps/Camera Lock"
    filename  = "TwoBridgeMap_V2_Navigate_Cam.SC2Map"
    players   = 2

lib.get_maps().pop("TwoBridgeMap_V2_Navigate_Cam", None)
lib.get_maps()["TwoBridgeMap_V2_Navigate_Cam"] = TwoBridgeMap_V2_Navigate_Cam()
...
class TwoBridgeEnv(gym.Env):
    """
    5 v 5 Two-Bridge V2_Navigate_Cam.
    ...
    def __init__(self,
        ...
        self._env = sc2_env.SC2Env(
            map_name="TwoBridgeMap_V2_Navigate_Cam",
